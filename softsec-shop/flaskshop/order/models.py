...
class Order(Model):
    ...
    # Task 2.2. (Azka) Save the address as UserAddress instead of HTML string
...
class OrderPayment(Model):
    ...
    # Task 3.5 (Azka) Function to update payment_no after being generated by Paypal
    def set_payment_no(self, payment_id):
        self.payment_no = payment_id
